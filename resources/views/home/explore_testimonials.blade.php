  ...
  <div class="px-6 py-10 max-w-7xl mx-auto">
    ...
    <div class="relative w-full">
      <div id="carouselContainer"
        ...
        <div class="explore_card relative min-w-[90%] sm:min-w-[48%] md:min-w-[23%] snap-start rounded-[28px] overflow-hidden">
          ...
          <div class="absolute top-4 left-4">
            <span class="explore_card_badge text-white text-xs px-3 py-1.5 rounded-full font-medium">
              {{ \App\Models\Post::CATEGORIES[$post->category]['emoji'] }} {{ \App\Models\Post::CATEGORIES[$post->category]['label'] }}
            </span>
          </div>
          @endif
          ...
          <div class="absolute bottom-5 left-5 right-5 text-white">
            <h3 class="text-lg font-semibold mb-1 leading-snug text-white">{{ $post->title }}</h3>
            <p class="text-sm text-white/85 font-medium flex items-center gap-2">
        ...
        @empty
        <p class="text-gray-500 py-10">No places to explore yet.</p>
        @endforelse
      </div>
    </div>
  </div>
...
<section id="testimonials" class="pt-6 pb-10 bg-white">
